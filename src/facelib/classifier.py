from facelib.distance import EuclideanDistance
from facelib.util import asRowMatrix
import logging
import numpy as np
...
try:
    ...
    logger = logging.getLogger("facelib.classifier.SVM")
...
class SVM(AbstractClassifier):
    ...
    def __init__(self, param=None):
        AbstractClassifier.__init__(self)
        self.logger = logging.getLogger("facelib.classifier.SVM")
        self.param = param
        self.svm = svm_model()
        self.param = param
